...
* Insert a description list pair before selection
* Insert a description list pair after selection
* Delete a description list pair

= Shortcuts =
* Cmd(⌘)+E (Mac) or Shift+E (Window): Insert a description list pair before selection
* Cmd(⌘)+D (Mac) or Shift+D (Window)): Insert a description list pair after selection
* Shift+ENTER (Mac or Window): Line break (`<br>`)
* Cmd(⌘)+ENTER (Mac) or Shift+ENTER (Window) only for `<dd>` elements: Insert a description list pair after selection
...
2. From the Description List Block control, you can insert Description List pairs (dt, dd) before or after the current selection or delete pairs.
